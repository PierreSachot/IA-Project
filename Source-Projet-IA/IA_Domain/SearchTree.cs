...
namespace Domain
{
    public class SearchTree
    {
        ...
        public GenericNode InitialiserSolution(GenericNode N0)
        {
        ...
        public List<GenericNode> GetResult(GenericNode N, GenericNode N0)
        {
        ...
        {
            GenericNode N = InitialiserSolution(N0);

            // tant que le noeud n'est pas terminal et que ouverts n'est pas vide
            while (L_Ouverts.Count != 0 && N.EndState() == false)
            {
                CalculerEtapeSuivante(ref L_Ouverts, ref L_Fermes, ref N);
            }
        ...
        public void GetSearchTree( TreeView TV, bool HideContent )
        {
            ...
            if (HideContent)
                TN = new TreeNode("?");
                 ...
                 TN = new TreeNode(L_Fermes[0].ToString());
            TV.Nodes.Add(TN);

            AjouteBranche ( L_Fermes[0], TN, HideContent );
        }
